...
[create an issue](https://github.com/bankiru/nginx-metrix/issues) before putting
...
* Review [lua style guide](http://lua-users.org/wiki/LuaStyleGuide) for
  more information.
...
1. [Fork the repository](https://github.com/bankiru/nginx-metrix/fork_select) to
  your Github account.
...
Nginx metrix is MIT licensed. See details in the LICENSE file. This is a very permissive
