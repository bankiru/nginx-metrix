...
describe('output.helper', function()
    ...
    it('render (stats)', function()
        ...
        assert.spy(_G.ngx.say).was.called_with(match.json_equal('{"third.com":{"vhost":"third.com","test":{"test":2}},"service":"nginx-metrix","second.com":{"vhost":"second.com","test":{"test":1}}}'))
        s1:revert()
        s2:revert()
    end)
